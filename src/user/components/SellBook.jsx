    ...
    <div>
        <div className="p-10 my-20 mx-5 bg-gray-200">
            ...
            <div className="flex justify-end mt-5">
                <button className='bg-gray-600 text-center p-2 rounded me-5 hover:bg-white hover:text-gray-400'>RESET</button>
                <button className='bg-blue-400 text-center p-2 rounded me-5 hover:bg-white hover:text-gray-400'>SUBMIT</button>
            </div>
        </div>
    </div>
  )
