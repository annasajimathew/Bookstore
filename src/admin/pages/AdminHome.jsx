    ...
    <div className='md:grid grid-cols-5'>
      ...
      <div className="col-span-4 p-10">
        ...
        <div className="md:grid grid-cols-4 gap-10 ">
          ...
          <div className="my-5 md:my-0 md:px-5">
            <div className="bg-green-100 p-4 flex items-center justify-center  rounded">
              ...
              {/* content */}
              <div className="ms-5">
                <h3 className="text-xl">Employee</h3>
                <h2 className="text-2xl">100+</h2>
              </div>
            </div>
          </div>
        ...
        <div className="md:grid grid-cols-2 mt-10">
          <h3 className='text-xl font-bold'>Monthly Revenew (Bar Chart)</h3>
          <h3 className='text-xl font-bold'>Monthly Revenew (Pie Chart)</h3>
        </div>
